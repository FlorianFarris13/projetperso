...
<body>
	<div class="mafia">
	<h1><center><U>La Mafia</U></center></h1>
		...
		<h3>Citation:</h3>
			<h5>"On obtient plus de choses en étant poli et armé qu'en étant juste poli. Cette simple ciation explique pour moi la persistance d'un phénomène comme la mafia à travers les siècles." <i><U>Al Capone.</U></i></h5></div>
<div class="nav1">
<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    <a class="nav-link" href="narco.php"> Le Narcotrafique d'Escobar</a>
  </li>
</ul>
</div>
...
<div class="origine">
	...
	<p>Afin de mieux comprendre les origines de la Mafia, penchons-nous sur diverses étymologies du terme "Mafia".
...
La consonace du mot "mafia" correspndrait à "mia figlia"("ma fille" en italien) et qui representerait le cri d'une mere aprés le viol de sa fille par, justement,un soldat fraçais lors des "Vêpres Siciliennes"("mia-figilia" se transformerait en "ma-fia","ma-fia". Bien sûr, ces dernieres origines ne sont pas fiables car elles ne peuvent pas être vérifiées.</br>
	La Mafia possède également son propre vocabulaire spécifique facillitant la communication entre ses membres. Voici quelques exemple:</br>
